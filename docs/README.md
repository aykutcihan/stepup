...
| `tutorials/frontend/` | Frontend learning guides — Vite, TypeScript, Vitest, Tailwind, ESLint, Docker, packages, openapi-typescript, services and constants, environment variables, React hooks |
