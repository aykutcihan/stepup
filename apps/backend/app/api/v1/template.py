...
from app.schemas.template import TemplateCreate, TemplateResponse, TemplateUpdate, TaskCreate, TaskUpdate, TaskReorder, TaskResponse
...
@router.patch("/{template_id}/tasks/{task_id}/reorder", response_model=TaskResponse)
async def reorder_task(
    ...
    task = await template_service.reorder_task(
        db=db, template_id=template_id, task_id=task_id, new_order=data.new_order
    )
    return TaskResponse.model_validate(task)
